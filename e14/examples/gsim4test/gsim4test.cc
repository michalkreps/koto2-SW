...
//#include "GsimE14Detector/GsimE14BHPVold.h"
...
int main(int argc, char** argv)
{
  ...
  new GsimDetectorFactory<GsimPolyhedra2WithASquareHole>(dm,"GsimPolyhedra2WithASquareHole");
  new GsimDetectorFactory<GsimTrap>(dm,"GsimTrap");
  new GsimDetectorFactory<GsimTrapWithHoles>(dm,"GsimTrapWithHoles");
  new GsimDetectorFactory<GsimTetraExtruded2>(dm,"GsimTetraExtruded2");
  ...
  new GsimDetectorFactory<GsimE14NCCModule>(dm,"GsimE14NCCModule");
  ...
  new GsimDetectorFactory<GsimE14IBAR>(dm,"GsimE14IBAR");
  new GsimDetectorFactory<GsimE14IBCV>(dm,"GsimE14IBCV");
  ...
  //new GsimDetectorFactory<GsimE14BHPVold>(dm,"GsimE14BHPVold");
  new GsimDetectorFactory<GsimE14CV>(dm,"GsimE14CV");
  new GsimDetectorFactory<GsimE14Membrane>(dm,"GsimE14Membrane");
  new GsimDetectorFactory<GsimE14Shield>(dm,"GsimE14Shield");
  new GsimDetectorFactory<GsimE14CsICover>(dm,"GsimE14CsICover");
  new GsimDetectorFactory<GsimE14CsIBackPlate>(dm,"GsimE14CsIBackPlate");
  new GsimDetectorFactory<GsimE14BHTS>(dm,"GsimE14BHTS");
  new GsimDetectorFactory<GsimE14BPCV>(dm,"GsimE14BPCV");
  new GsimDetectorFactory<GsimE14NewBHCV>(dm,"GsimE14NewBHCV");
  new GsimDetectorFactory<GsimE14BHGC>(dm,"GsimE14BHGC");
  new GsimDetectorFactory<GsimE14DCV>(dm,"GsimE14DCV");
  new GsimDetectorFactory<GsimE14UCV>(dm,"GsimE14UCV");

  new GsimDetectorFactory<GsimE14NeutronMonitor>(dm,"GsimE14NeutronMonitor");
  ...
  new GsimDetectorFactory<GsimE14Step2CSI>(dm,"GsimE14Step2CSI");
  new GsimDetectorFactory<GsimKOTOIIBarrel>(dm,"GsimKOTOIIBarrel");
  new GsimDetectorFactory<GsimKOTOIICalorimeter>(dm,"GsimKOTOIICalorimeter");
  new GsimDetectorFactory<GsimKOTOIIOuterVeto>(dm,"GsimKOTOIIOuterVeto");
  new GsimDetectorFactory<GsimKOTOIIUpstreamCollar>(dm,"GsimKOTOIIUpstreamCollar");
  ...
  new GsimSpectrumFactory<GsimE14SatoSpectrum>("GsimE14SatoSpectrum");
  new GsimSpectrumFactory<GsimE14HalonSpectrum>("GsimE14HalonSpectrum");
  new GsimSpectrumFactory<GsimE14CoreLikeK>("GsimE14CoreLikeK");
  new GsimSpectrumFactory<GsimE14ALPSpectrum>("GsimE14ALPSpectrum");
  ...
  new GsimSpectrumFactory<GsimE14dist2d_kl>("GsimE14dist2d_kl");
  new GsimSpectrumFactory<GsimE14dist2d_n>("GsimE14dist2d_n");
  new GsimSpectrumFactory<GsimE14dist2d_g>("GsimE14dist2d_g");


  new GsimSpectrumFactory<GsimE14Step1Spectrum>("GsimE14Step1Spectrum");
  new GsimSpectrumFactory<GsimE14Step2IsoePointSpectrum>("GsimE14Step2IsoePointSpectrum");
  new GsimSpectrumFactory<GsimE14Step2IsoeSpectrum>("GsimE14Step2IsoeSpectrum");
  new GsimSpectrumFactory<GsimE14Step2HNPointSpectrum>("GsimE14Step2HNPointSpectrum");
