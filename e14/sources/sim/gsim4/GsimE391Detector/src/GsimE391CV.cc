  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  // double  p_chvs1[] = { -360./chvs1_ndiv/2, 360., 4, 4,
  ...
  // double  p_chv1[] = { -360./chv1_ndiv/2, 360./chv1_ndiv, 1, 2,
  ...
  // double  p_chv3[] = { chv3_rmin,chv3_rmax,chv3_len/2,
  ...
  //double  p_chv4[] = { chv4_x/2,chv4_y/2,chv4_len/2 };
