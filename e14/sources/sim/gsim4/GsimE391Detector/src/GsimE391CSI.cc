  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  //double  p_csir[] = { csir_rmin,csir_rmax, Csir_Len/2 };
  ...
  //double  p_cscl[] = { cscl_rmin,cscl_rmax, cscl_len/2 };
  ...
  double  csec_rmin = 20;
  //double  p_csec[] = { csec_rmin,csec_rmax, csec_thick/2 };
  paramVec.clear();
      ...
      if ( 11<=x && x<=15 && 11<=y && y<=15 ){
        ...
        if ( x == 11 ){
          ...
          for( int ki=0;ki<nk;ki++ ){
            //double  p_csic[] = { KtevCsic_XY/2, KtevCsic_XY/2, KtevCsic_Len/2 };
        ...
        if ( csiblock[yy][x] == '0' ){
          //double  p_csic[] = { Csic_XY/2, Csic_XY/2, Csic_Len/2 };
          id++;
          { //////
		...
		boxKEK3->cloneDetector(G4ThreeVector(c_csic_x*cm,c_csic_y*cm,c_csic_z*cm),
          ...
          { //////
            ...
            if ( cd == 4 || cd == 6 ){
              ...
              //double  p_csdb[] = { Csic_XY/2,csdb_y[cd]/2,Csic_Len/2 };
	      paramVec.clear();
...
bool GsimE391CSI::postTrackingAction(const G4Track* ) {
  return false;
}
