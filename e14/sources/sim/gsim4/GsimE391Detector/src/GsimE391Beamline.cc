...
//   }
  ...
  // Vacuum chamber (SUS)
  {
    ...
    GsimPolycone2* pc2 = new GsimPolycone2(std::string(nam),mf2,
					   G4ThreeVector(x*cm,y*cm,z*cm),
					   G4ThreeVector(0,0,0));
    pc2->setOuterMaterial("G4_Fe");
    pc2->setParameters(paramVec);
    pc2->setOuterColor("gray70");
    mf2->addDaughter(pc2);
  }
...
void GsimE391Beamline::setFastSimulationLevel(int )
{
#ifdef GSIMDEBUG
