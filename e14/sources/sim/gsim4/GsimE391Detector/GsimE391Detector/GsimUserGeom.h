...
namespace E391 {
  ...
  //static const double  Csir_Zmin    = 605; // CsI region
  //static const double  Csic_Zmin    = 610; // CsI face
  ...
  static const double  KtevCsic_Gap = (Csic_Gap*5/7);

  // Measured by Misha (27/Mar/2004)
  static const double  Detpos_csi_z   = Csic_Zmin;             // 610.0 cm
  static const double  Detpos_cc03_z  = Detpos_csi_z - 5.;     // 605.0 cm
  static const double  Detpos_cc04_z  = Detpos_csi_z + 95.5;   // 705.5 cm
  static const double  Detpos_cc05_z  = Detpos_csi_z + 259.3;  // 869.3 cm
  static const double  Detpos_cc06_z  = Detpos_csi_z + 310.8;  // 920.8 cm
  static const double  Detpos_cc07_z  = Detpos_csi_z + 385.8;  // 995.8 cm
  static const double  Detpos_bhcv_z  = Detpos_csi_z + 414.5;  // 1024.5 cm
  static const double  Detpos_ba_z    = Detpos_csi_z + 444.5;  // 1054.5 cm
  
  //
  //static const double  Detpos_cbar_z  = 135.;  // z = 135 cm
  static const double  Detpos_cbar_z  = 134.8;  // z = 134.8 cm (updated : Mon Jun 21 22:45:34 JST 2004)
