  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  if(m_mode==2) {
    ...
    if(m_userFlag==2011 ||
       ...
       m_userFlag==202102 ||
       m_userFlag==202306 ||
       m_userFlag==1000000 || // density larger by 10%
       m_userFlag==1000001    // density smaller by 10%
       ) {
      withMylar=false;
      withStructure=true;
      withFCV=true;
	...
	->report("warning",
		 "Invalid user flag is assigned. CV is not constructed.");
      return;
    }
	...
	new GsimPolyhedra2WithASquareHole("rMylar",this,
      ...
      rmylar->setOuterMaterial("G4_MYLAR");
      addDaughter(rmylar);
	...
	new GsimPolyhedra2WithASquareHole("rCFRP",this,
      ...
      rcfrp->setOuterMaterial("GsimCFRP");
	...
	new GsimPolyhedra2WithASquareHole("fCFRP",this,
      ...
      double zFrame0[4]={frontZ0+tCFRP+tAL/2.,
			 frontZ0+tCFRP+tAL+(wAL-tAL*2)+tAL/2.,
			 rearZ0-tAL/2.,
			 rearZ0-tAL-(wAL-tAL*2)-tAL/2.};

      GsimPolyhedra2* frame0 =0;
      for(int iF=0;iF<4;iF++) {
	if(iF==2) {
	  std::vector<double> paramVecS;
	  for(int iSide=0;iSide<16;iSide++) {
	    if(iSide==1 || iSide==5 || iSide==9 || iSide==13) {
	      //Need cut to avoid overlap to R10 scinti.
	      paramVecS.clear();
	      paramVecS.push_back(tAL);
	      paramVecS.push_back(0);
	      paramVecS.push_back(0);
	      paramVecS.push_back(30*mm);
	      paramVecS.push_back((dAL-30*mm)*tan(360*deg/32.)*2);
	      paramVecS.push_back(dAL*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      paramVecS.push_back(30*mm);
	      paramVecS.push_back((dAL-30*mm)*tan(360*deg/32.)*2);
	      paramVecS.push_back(dAL*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      G4ThreeVector posS(0,dAL-30*mm/2.,zFrame0[iF]);
	      posS.rotateZ(iSide*360*deg/16.);
	      G4ThreeVector rotS(0,0,iSide*360*deg/16.);
	      
	      std::ostringstream os;
	      os << "Frame0_" << iF << "_" << iSide;
	      GsimTrap* trap = new GsimTrap(os.str(),this,
					    posS,rotS);
	      trap->setParameters(paramVecS);
	      trap->setOuterColor("gray25");
	      trap->setOuterMaterial("G4_Al");
	      addDaughter(trap);
	      ...
	      paramVecS.push_back(0);
	      paramVecS.push_back(0);
	      paramVecS.push_back(10*mm);
	      paramVecS.push_back(119*mm);
	      paramVecS.push_back(119*mm+10*mm*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      paramVecS.push_back(10*mm);
	      paramVecS.push_back(119*mm);
	      paramVecS.push_back(119*mm+10*mm*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      G4ThreeVector posS1(  -(dAL-hAL)*tan(360*deg/32.) +119/2.*mm,
				    dAL-30*mm-10*mm/2.,zFrame0[iF]);
	      posS1.rotateZ(iSide*360*deg/16.);
	      std::ostringstream os1;
	      os1 << "Frame0_" << iF << "_" << iSide << "_1";
	      trap = new GsimTrap(os1.str(),this,
				  posS1,rotS);
	      trap->setParameters(paramVecS);
	      trap->setOuterColor("gray25");
	      trap->setOuterMaterial("G4_Al");
	      ...
	      paramVecS.push_back(0);
	      paramVecS.push_back(10*mm);
	      paramVecS.push_back(224*mm);
	      paramVecS.push_back(224*mm+10*mm*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      paramVecS.push_back(10*mm);
	      paramVecS.push_back(224*mm);
	      paramVecS.push_back(224*mm+10*mm*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      G4ThreeVector posS2(  +(dAL-hAL)*tan(360*deg/32.) -224/2.*mm,
				    dAL-30*mm-10*mm/2.,zFrame0[iF]);
	      posS2.rotateZ(iSide*360*deg/16.);
	      std::ostringstream os2;
	      os2 << "Frame0_" << iF << "_" << iSide << "_2";
	      trap = new GsimTrap(os2.str(),this,
				  posS2,rotS);
	      trap->setParameters(paramVecS);
	      trap->setOuterColor("gray25");
	      trap->setOuterMaterial("G4_Al");
	      ...
	      paramVecS.push_back(0);
	      paramVecS.push_back(0);
	      paramVecS.push_back(hAL);
	      paramVecS.push_back((dAL-hAL)*tan(360*deg/32.)*2);
	      paramVecS.push_back(dAL*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      paramVecS.push_back(hAL);
	      paramVecS.push_back((dAL-hAL)*tan(360*deg/32.)*2);
	      paramVecS.push_back(dAL*tan(360*deg/32.)*2);
	      paramVecS.push_back(0);
	      G4ThreeVector posS(0,dAL-hAL/2.,zFrame0[iF]);
	      posS.rotateZ(iSide*360*deg/16.);
	      G4ThreeVector rotS(0,0,iSide*360*deg/16.);
	  ...
	  std::ostringstream os;
	  os << "Frame0_" << iF;
	  frame0 = new GsimPolyhedra2(os.str(),this,
				      G4ThreeVector(0,0,zFrame0[iF]),
				      G4ThreeVector(0,0,0));
      ...
      GsimPolyhedra2* frame2 = new GsimPolyhedra2("Frame2",this,
						  G4ThreeVector(0,0,rearZ0-tAL-(wAL-tAL*2)/2.),
						  G4ThreeVector(0,0,0));
      frame2->setParameters(paramVec);
      frame2->setOuterColor("gray25");
      frame2->setOuterMaterial("G4_Al");
      addDaughter(frame2);

      //CV Arm
      
      double lArmUp=266*mm;
      double tArmUp=12*mm;
      double posXUp=984*mm-tArmUp/2.;
      double posZUp=frontZ0+tCFRP+lArmUp/2.;
      if(m_userFlag>=201902) {
	lArmUp=347*mm;
	tArmUp=12*mm;
	posXUp=982*mm-tArmUp/2.;
	posZUp=
	  frontZ0+tCFRP+wAL/2.-36*mm
	  +lArmUp/2.;
      }

      
      paramVec.clear();
      paramVec.push_back(tArmUp);
      paramVec.push_back(120*mm);
      paramVec.push_back(lArmUp);
      GsimBox* armUp = new GsimBox("armUp",this,
				   G4ThreeVector(posXUp,0,posZUp),
				   G4ThreeVector(0,0,0));
      armUp->setParameters(paramVec);
      armUp->setOuterColor("gray25");
      //armUp->setOuterMaterial("G4_Al");
      armUp->setOuterMaterial("GsimSUS");
      addDaughter(armUp);
      armUp->cloneDetector(
			   G4ThreeVector(-posXUp,0,posZUp),
			   G4ThreeVector(0,0,0)
      ...
      double lArmDown=80*mm;
      double tArmDown=5*mm;
      double posXDown=984*mm-tArmDown/2.;
      double posZDown=frontZ0+tCFRP+lArmUp+lArmDown/2.;
      if(m_userFlag>=201902) {
	lArmDown=210*mm;
	tArmDown=7*mm;
	posXDown=982*mm-tArmDown/2.;
	posZDown=
	  frontZ0+tCFRP+wAL/2.-36*mm
	  +lArmUp+
	  +lArmDown/2.;
      ...
      paramVec.clear();
      paramVec.push_back(tArmDown);
      paramVec.push_back(120*mm);
      paramVec.push_back(lArmDown);
      GsimBox* armDown = new GsimBox("armDown",this,
				     G4ThreeVector(posXDown,0,posZDown),
				     G4ThreeVector(0,0,0));
      armDown->setParameters(paramVec);
      armDown->setOuterColor("gray25");
      //armDown->setOuterMaterial("G4_Al");
      armDown->setOuterMaterial("GsimSUS");
      addDaughter(armDown);
      armDown->cloneDetector(
			     G4ThreeVector(-posXDown,0,posZDown),
			     G4ThreeVector(0,0,0)
			     );
      armDown->cloneDetector(
			     G4ThreeVector(0,posXDown,posZDown),
			     G4ThreeVector(0,0,90*deg)
			     );
      armDown->cloneDetector(
			     G4ThreeVector(0,-posXDown,posZDown),
      ...
      if(m_userFlag>=201902) {
	//Arm base
	double lArmBase=210*mm;
	double tArmBase=10*mm;
	double posXBase=982*mm-tArmDown-tArmBase/2.;
	double posZBase=
	  frontZ0+tCFRP+wAL/2.-36*mm
	  +lArmUp+
	  +lArmBase/2.;
	...
	paramVec.clear();
	paramVec.push_back(tArmBase);
	paramVec.push_back(120*mm);
	paramVec.push_back(lArmBase);
	GsimBox* armBase = new GsimBox("armBase",this,
				       G4ThreeVector(posXBase,0,posZBase),
				       G4ThreeVector(0,0,0));
	armBase->setParameters(paramVec);
	armBase->setOuterColor("gray25");
	armBase->setOuterMaterial("G4_Al");
	addDaughter(armBase);
	armBase->cloneDetector(
			       G4ThreeVector(-posXBase,0,posZBase),
			       G4ThreeVector(0,0,0)
			       );
	armBase->cloneDetector(
			       G4ThreeVector(0,posXBase,posZBase),
			       G4ThreeVector(0,0,90*deg)
			       );
	armBase->cloneDetector(
			       G4ThreeVector(0,-posXBase,posZBase),
	...
	if(i==4) {
      ...
      if(m_userFlag==1000000) {
	trapSC->setOuterMaterial("GsimSC_Plus");
      } else if(m_userFlag==1000001) {
	trapSC->setOuterMaterial("GsimSC_Minus");
      }
			   ...
			   double& xCenter,double& yCenter,double& zCenter)
{
  ...
  double LL=l+thick/sqrt(3.);
  double CX=LL/2.-thick/sqrt(3.);
  double CY=-width/2.-thick/sqrt(3.);
  double CZ=-thick;
...
void GsimE14CV::comment()
{
  std::cout << "GsimE14CV Z position:" << std::endl;
  std::cout << "    RCV scintillator downstream surface." << std::endl;
  std::cout << "    Place it 52.3 mm upsteram of CsI.(2012.12)" << std::endl;
  std::cout << "    z=(-5.23+614.8)*cm" << std::endl;
  std::cout << "When userFlag is 201605, place it downstream by 2 cm," << std::endl;
  std::cout << "    and further 8.5 mm upsteram of CsI," << std::endl;
  std::cout << "    z=(-5.23-0.85+614.8+2)*cm" << std::endl;
  std::cout << "When userFlag is 201902, place it downstream by 2 cm," << std::endl;
  std::cout << "    and further 9.3 mm upsteram of CsI," << std::endl;
  std::cout << "    z=(-5.23-0.93+614.8+2)*cm" << std::endl;
  std::cout << "GsimE14CV userFlag:" << std::endl;
  std::cout << "    0: w/o  Mylar, with Structure, with FCV, with RCV (default)" << std::endl;
  std::cout << "    1: w/o  Mylar, w/o  Structure, with FCV, with RCV" << std::endl;
  std::cout << "    2: w/o  Mylar, w/o  Structure, w/o  FCV, with RCV" << std::endl;
  std::cout << "    3: w/o  Mylar, w/o  Structure, with FCV, w/o  RCV" << std::endl;
  std::cout << "    4: with Mylar, wiht  Structure,with FCV, with RCV" << std::endl;
  std::cout << " fibers are not sensitive detectors to simulate the grooves." << std::endl;
}


void GsimE14CV::setFastSimulationLevel(int level)
{
#ifdef GSIMDEBUG
