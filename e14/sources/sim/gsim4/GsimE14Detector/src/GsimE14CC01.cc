  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  // double p_seg1[] = {cc02_len/2.0, 0.0,     0.0,
  //                   h1/2.0,       l2/2.0,  l1/2.0,  -angle1,
  //                   h1/2.0,       l2/2.0,  l1/2.0,  -angle1 };

  // double p_seg2[] = {cc02_len/2.0, 0.0,     0.0,
  ...
  // Layer structure
  {
    ...
    // double p_scn1[] = {scint_thick/2.0,      0.0,     0.0,
    //                   h1/2.0,       l2/2.0,  l1/2.0,  -angle1,
    //                   h1/2.0,       l2/2.0,  l1/2.0,  -angle1 };

    // double p_scn2[] = {scint_thick/2.0,    0.0,     0.0,
    //                   h2/2.0,     l3/2.0,  l2/2.0,  angle2,
    //                   h2/2.0,     l3/2.0,  l2/2.0,  angle2 };
...
//            p_scn2, sizeof(p_scn2)/sizeof(float),ivol);
    ...
    // double p_al1[] = {al_thick/2.0,      0.0,     0.0,
    //                  h1/2.0,       l2/2.0,  l1/2.0,  -angle1,
    //                  h1/2.0,       l2/2.0,  l1/2.0,  -angle1 };
    // double p_al2[] = {al_thick/2.0,      0.0,     0.0,
    //                  h2/2.0,       l3/2.0,  l2/2.0,  angle2,
    //                  h2/2.0,       l3/2.0,  l2/2.0,  angle2 };
...
//            p_al2, sizeof(p_al2)/sizeof(float),ivol);
    ...
    // double p_lead1mm_seg1[] = {pbsb1_thick/2.0,      0.0,     0.0,
    //                           h1/2.0,       l2/2.0,  l1/2.0,  -angle1,
    //                           h1/2.0,       l2/2.0,  l1/2.0,  -angle1 };
    // double p_lead1mm_seg2[] = {pbsb1_thick/2.0,      0.0,     0.0,
    //                           h2/2.0,       l3/2.0,  l2/2.0,  angle2,
    //                           h2/2.0,       l3/2.0,  l2/2.0,  angle2 };
...
//            p_lead1mm_seg2, sizeof(p_lead1mm_seg2)/sizeof(float),ivol);
    ...
    // double p_lead2mm_seg1[] = {pbsb2_thick/2.0,      0.0,     0.0,
    // 			       h1/2.0,       l2/2.0,  l1/2.0,  -angle1,
    //                           h1/2.0,       l2/2.0,  l1/2.0,  -angle1 };
    // double p_lead2mm_seg2[] = {pbsb2_thick/2.0,      0.0,     0.0,
    //                           h2/2.0,       l3/2.0,  l2/2.0,  angle2,
    //                           h2/2.0,       l3/2.0,  l2/2.0,  angle2 };
...
//            p_lead2mm_seg2, sizeof(p_lead2mm_seg2)/sizeof(float),ivol);
    ...
    // double p_brass1[] = {brass_thick/2.0,      0.0,     0.0,
    //                     h1/2.0,       l2/2.0,  l1/2.0,  -angle1,
    //                     h1/2.0,       l2/2.0,  l1/2.0,  -angle1 };
    // double p_brass2[] = {brass_thick/2.0,      0.0,     0.0,
    //                     h2/2.0,       l3/2.0,  l2/2.0,  angle2,
    //                     h2/2.0,       l3/2.0,  l2/2.0,  angle2 };
