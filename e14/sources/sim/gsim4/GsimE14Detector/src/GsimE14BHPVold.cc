/**
 *  @file
 *  @brief  GsimE14BHPVold
 *  $Id: GsimE14BHPVold.cc,v 1.3 2006/12/06 19:04:45 nanjo Exp $ 
 *  $Log: GsimE14BHPVold.cc,v $
...
GsimE14BHPVold::GsimE14BHPVold(std::string name,
  ...
  : GsimDetector(name,motherDetector,transV,rotV,userFlag)
{
  ...
  m_className = "GsimE14BHPVold";
  // BHPV

  // Photon Veto
  if(m_userFlag-int(m_userFlag/10)*10>0) {
    m_opticalMode=true;
  } else {
    m_opticalMode=false;
  }
...
GsimE14BHPVold::~GsimE14BHPVold()
{
  delete m_winstonCone;
}

void GsimE14BHPVold::setFastSimulationLevel(int level)
{
#ifdef GSIMDEBUG
...
double GsimE14BHPVold::getBHPVLength() {
...
bool GsimE14BHPVold::processHits(const G4Step* aStep,G4TouchableHistory* ROhist, std::list<int>& )
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
  ...
  bool isTraced=traceFromInsideAerogel(aStep,ROhist);
  
  if(isTraced) return true;
  else         return false;
...
bool GsimE14BHPVold::traceFromInsideAerogel(const G4Step* aStep,G4TouchableHistory* )
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
double GsimE14BHPVold::dNextAbsorption(double waveL)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
double GsimE14BHPVold::dNextScattering(double waveL)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimE14BHPVold::scatterInAerogel(double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
bool GsimE14BHPVold::traceAerogel(double waveL,double* pPos, double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
bool GsimE14BHPVold::traceOpticalBox(double ,double* pPos, double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
  ...
  double radloc=M_PI*m_mirrorAngle/180.;
  double nVecmir[3]=
    {0.,
     std::cos(radloc),
     -1. * std::sin(radloc)
  ...
  while(!isReach) {
    ...
    double lenmir=-(pPos[1]-pPos[2]*std::tan(radloc))/(pVec[1]-pVec[2]*std::tan(radloc));
    double lenside=0.;
    if (pVec[0]>0.) {
...
bool GsimE14BHPVold::traceWCone(double ,double* pPos, double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
double GsimE14BHPVold::getPMTQE(double waveL)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimE14BHPVold::translateFromGlobalToAG(const G4Step* aStep,double* pPos, double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimE14BHPVold::translateFromAGToOBox(double* pPos, double* )
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimE14BHPVold::translateFromOBoxToWCone(double* pPos, double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimE14BHPVold::translateFromWConeToOBox(double* pPos, double* pVec)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
