 ...
 *  $Log:$
 */
#ifndef GsimE14BHPVold_h
#define GsimE14BHPVold_h
...
/**
 *  @class GsimE14BHPVold
 *  @brief Detector.
 *
 *  This class provides ...
 */

class GsimE14BHPVold : public GsimDetector
{
 public:
  GsimE14BHPVold(std::string name,
	      GsimDetector* motherDetector,
	      G4ThreeVector transV,
	      G4ThreeVector rotV,
	      int userFlag=0);
  
  virtual ~GsimE14BHPVold();
  
  virtual void setFastSimulationLevel(int level);
  virtual bool processHits(const G4Step* aStep,G4TouchableHistory* ROhist, std::list<int>& );
