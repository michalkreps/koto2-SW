...
GsimCosmicSpectrumZMessenger::GsimCosmicSpectrumZMessenger(GsimCosmicSpectrumZ* spectrum)
  :m_spectrum(spectrum)
{
#ifdef GSIMDEBUG
  ...
  m_spectrumDir->SetGuidance("Control GsimCosmicSpectrumZ.");
...
GsimCosmicSpectrumZMessenger::~GsimCosmicSpectrumZMessenger()
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimCosmicSpectrumZMessenger::SetNewValue(G4UIcommand* command,G4String aValue)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
  ...
  if(!isValid) {
    std::string msg = "Wrong command  at GsimCosmicSpectrumZMessenger::";
