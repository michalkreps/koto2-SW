  ...
  :m_runAction(runAction)
{
...

  {
    ...
    m_cmdLoadSeed->SetGuidance("loadSeed fileName treeID eventNumber");
    m_cmdLoadSeed->SetGuidance("         treeID is 0 for eventTree00, for example.");
    m_cmdLoadSeed->SetGuidance("         eventNumber is Event.event_number.");
