...
TH1D* GsimFileIO::
createHistogram(const char* ,const char* ,int ,double ,double )
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void  GsimFileIO::
fillHistogram(const char* ,double )
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
TH2D* GsimFileIO::
createHistogram(const char* ,const char* ,
		int ,double ,double ,
		int ,double ,double )
{
#ifdef GSIMDEBUG
...
void  GsimFileIO::
fillHistogram(const char* ,double ,double )
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
