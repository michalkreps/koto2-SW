...
void GsimRootIO::endOfEventAction(int ,bool withDataToStore) {
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
  if(withDataToStore) {
...
void GsimRootIO::readCommand(const char* line)
{
...
#endif
  {
    ...
    if(tmpline.size()>=17 && std::string(tmpline,0,17)=="/control/execute ") {
...
TH1D* GsimRootIO::
createHistogram(const char* name, const char* title,int nbin,double xmin,double xmax)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void  GsimRootIO::
fillHistogram(const char* name,double value)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
TH2D* GsimRootIO::
createHistogram(const char* name, const char* title,
...
void  GsimRootIO::
fillHistogram(const char* name,double xvalue,double yvalue)
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
