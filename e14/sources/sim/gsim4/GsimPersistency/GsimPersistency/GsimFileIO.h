...
public:
  ...
  virtual TH1D* createHistogram(const char* name,const char* title,
				int nbin,double xmin,double xmax);
  virtual void  fillHistogram(const char* name,double value);

  virtual TH2D* createHistogram(const char* name, const char* title,
			int nbinx,double xmin,double xmax,
			int nbiny,double ymin,double ymax);
  virtual void  fillHistogram(const char* name,double xvalue,double yvalue);
