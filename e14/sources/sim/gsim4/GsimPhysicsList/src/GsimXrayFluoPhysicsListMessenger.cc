...
GsimXrayFluoPhysicsListMessenger::GsimXrayFluoPhysicsListMessenger(GsimXrayFluoPhysicsList* pPhys)
:pPhysicsList(pPhys)
{
...
GsimXrayFluoPhysicsListMessenger::~GsimXrayFluoPhysicsListMessenger()
{
  delete pListCmd;
  delete gammaCutCmd;
  delete electCutCmd;
...
void GsimXrayFluoPhysicsListMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{ 
  if( command == pListCmd )
