...
//
//
// File name:     GsimeBremsstrahlungModel
//
...
GsimeBremsstrahlungModel::GsimeBremsstrahlungModel(const G4ParticleDefinition* p,
                                               const G4String& nam)
  : G4VEmModel(nam),
    particle(0),
    isElectron(true),
...
GsimeBremsstrahlungModel::~GsimeBremsstrahlungModel()
{
...
void GsimeBremsstrahlungModel::SetParticle(const G4ParticleDefinition* p)
{
  particle = p;
...
void GsimeBremsstrahlungModel::Initialise(const G4ParticleDefinition* p,
...
G4double GsimeBremsstrahlungModel::ComputeDEDXPerVolume(
...
G4double GsimeBremsstrahlungModel::ComputeBremLoss(G4double Z, G4double T,
                                                 G4double Cut)
...
G4double GsimeBremsstrahlungModel::PositronCorrFactorLoss(G4double Z,
...
G4double GsimeBremsstrahlungModel::CrossSectionPerVolume(
					      const G4Material* material,
                                              const G4ParticleDefinition* p,
                                                    G4double kineticEnergy,
                                                    G4double cutEnergy,
...
G4double GsimeBremsstrahlungModel::ComputeCrossSectionPerAtom(
...
G4double GsimeBremsstrahlungModel::PositronCorrFactorSigma( G4double Z,
                                 G4double kineticEnergy, G4double cut)
...
G4DataVector* GsimeBremsstrahlungModel::ComputePartialSumSigma(
              const G4Material* material,
                    G4double kineticEnergy,
                    G4double cut)
...
void GsimeBremsstrahlungModel::SampleSecondaries(std::vector<G4DynamicParticle*>* vdp, 
...
//
  ...
  do {
	...
	/*
	if ( greject > grejmax ) {
            G4cout << "### GsimeBremsstrahlungModel Warning: Majoranta exceeded! "
                   << greject << " > " << grejmax
                   << " x= " << x 
		   << " e= " << kineticEnergy
                   << G4endl;
...
const G4Element* GsimeBremsstrahlungModel::SelectRandomAtom(
           const G4MaterialCutsCouple* couple) 
{
...
G4double GsimeBremsstrahlungModel::SupressionFunction(const G4Material* material,
