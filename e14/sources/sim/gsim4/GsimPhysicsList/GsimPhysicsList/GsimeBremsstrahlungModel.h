...
#ifndef GsimeBremsstrahlungModel_h
#define GsimeBremsstrahlungModel_h 1
...
class GsimeBremsstrahlungModel : public G4VEmModel
{

public:

  GsimeBremsstrahlungModel(const G4ParticleDefinition* p = 0, 
			 const G4String& nam = "eBrem");

  virtual ~GsimeBremsstrahlungModel();
...
private:
  ...
  GsimeBremsstrahlungModel & operator=(const  GsimeBremsstrahlungModel &right);
  GsimeBremsstrahlungModel(const  GsimeBremsstrahlungModel&);
...
inline G4double GsimeBremsstrahlungModel::ScreenFunction1(G4double ScreenVariable)
...
inline
G4double GsimeBremsstrahlungModel::ScreenFunction2(G4double ScreenVariable)
