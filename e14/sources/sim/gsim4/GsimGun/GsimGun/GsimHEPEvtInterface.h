...
class GsimHEPEvtInterface : public GsimPrimaryGeneratorAction
{
 public:
  ...
  /**
   *  @function setDetectorShiftZ
   *  @brief set detector shift in Z
   */
  void setDetectorShiftZ(double dZ);

  /**
   *  @function setBeamShiftX
   *  @brief set beam shift in X
   */
  void setBeamShiftX(double dX);

  /**
   *  @function setBeamShiftY
   *  @brief set beam shift in Y
   */
  void setBeamShiftY(double dY);
  ...
  /**
   *  @function getDetectorShiftZ
   *  @brief get detector shift in Z
   */
  inline double getDetectorShiftZ();

  /**
   *  @function getBeamShiftX
   *  @brief get beam shift in X
   */
  inline double getBeamShiftX();

  /**
   *  @function getBeamShiftY
   *  @brief get beam shift in Y
   */
  inline double getBeamShiftY();
 ...
 protected:
  ...
  /**
   *  @brief The process flag.
   */
  bool     m_processed;
  /**
   *  @brief The loop mode flag.
   */
  bool     m_loopMode;
  /**
...
double GsimHEPEvtInterface::getDetectorShiftZ()
{
  return m_detectorShiftZ;
}

double GsimHEPEvtInterface::getBeamShiftX()
{
  return m_beamShiftX;
}

double GsimHEPEvtInterface::getBeamShiftY()
{
  return m_beamShiftY;
}
