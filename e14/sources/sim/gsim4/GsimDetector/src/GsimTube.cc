...
(G4Tubs& tube, const G4int , const G4VPhysicalVolume*) const
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
...
void GsimTube::extractTwoPlanesDXF(std::list<TVector3>& v0List,
				   ...
				   )
{
  ...
  double r1=m_parameterArray[1];
  double dz=m_parameterArray[2]/2.;
  double phi0=m_parameterArray[3];
  double dphi=m_parameterArray[4];
