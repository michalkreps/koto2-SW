...
void GsimTubeWithAHole::extractTwoPlanesDXF(std::list<TVector3>& v0List,
					    ...
					    )
{
  ...
  double r0=m_parameterArray[0];
  double dz=m_parameterArray[1]/2.;
  double phi0=0;
  double dphi=2.*M_PI;
  ...
  double sx=m_parameterArray[2]/2.;
  double sy=m_parameterArray[3]/2.;
  double dx=m_parameterArray[4]/2.;
  double dy=m_parameterArray[5]/2.;
  
  TVector3 v[2][4];
  v[0][0]=TVector3(+dx+sx,+dy+sy,+dz);
  v[0][1]=TVector3(-dx+sx,+dy+sy,+dz);
  v[0][2]=TVector3(-dx+sx,-dy+sy,+dz);
  v[0][3]=TVector3(+dx+sx,-dy+sy,+dz);
  v[1][0]=TVector3(+dx+sx,+dy+sy,-dz);
  v[1][1]=TVector3(-dx+sx,+dy+sy,-dz);
  v[1][2]=TVector3(-dx+sx,-dy+sy,-dz);
  v[1][3]=TVector3(+dx+sx,-dy+sy,-dz);
