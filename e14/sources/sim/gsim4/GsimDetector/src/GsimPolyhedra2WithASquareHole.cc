...
void GsimPolyhedra2WithASquareHole::extractTwoPlanesDXF(std::list<TVector3>& v0List,
							...
							)
{
  ...
  double dmax  =m_parameterArray[4];
  double dmin  =m_parameterArray[5];

  double theta=dphi/nSide;
  double r0=dmax/std::cos(theta/2.);
