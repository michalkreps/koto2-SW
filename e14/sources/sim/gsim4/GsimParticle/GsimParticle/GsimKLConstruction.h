...
class GsimKLConstruction
{
 public:
  ...
  void switchDecayTable(int iMode);
 ...
 private:
  ...
  /**
   *  @brief Generateor of custom decay table
   */
  void generateCustomDecayTable();
  ...
  /**
   *  @brief Which decayTbale is used for kaon0L(0:original,1:custom)
   */
  bool m_decayTableMode;
  
  /**
   *  @brief Original kaon0L decay table
   */
  G4DecayTable* m_originalKaon0LDecayTable;
  G4DecayTable* m_customKaon0LDecayTable;
};
