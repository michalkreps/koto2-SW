...
double GsimEEGDecayChannel::calc_F1(double t){
...
G4DecayProducts* GsimEEGDecayChannel::DecayIt(G4double) 
{
#ifdef GSIMDEBUG
  GsimMessage::getInstance()->debugEnter(__PRETTY_FUNCTION__);
#endif
