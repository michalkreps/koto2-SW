...
class E14FsimAnalysisManager
{
 public:
  ...
  void disableCSIModule(bool isDisable=true);
  void disableNCCModule(bool isDisable=true);
  void disableCSIVeto(bool isDisable=true);
 ...
 private:
  ...
  int m_nEventRequest;
  int m_event;
  bool m_isCSIModuleDisabled;
  bool m_isNCCModuleDisabled;
