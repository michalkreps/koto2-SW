...
public:
  ...
  int           m_nMcGamma;
  int           m_mcGammaID[10];//[m_nMcGamma]
  double        m_mcGammaE[10];//[m_nMcGamma]
  int           m_mcParentID[10];//[m_nMcGamm
  double        m_mcGammaT[10];//[m_nMcGamma]a]
  TVector3      m_mcGammaPos[10];//[m_nMcGamma]a]
  TVector3      m_mcGammaMome[10];//[m_nMcGamma]a]
