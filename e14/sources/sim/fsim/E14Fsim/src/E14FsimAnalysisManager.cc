...
E14FsimAnalysisManager::E14FsimAnalysisManager(char* ifileName,char* ofileName, int nSel,
  ...
  m_isCSIModuleDisabled=false;
  m_isNCCModuleDisabled=false;
...
void E14FsimAnalysisManager::disableCSIModule(bool isDisable)
{
  m_CSIModule->disable(isDisable);
  m_isCSIModuleDisabled=isDisable;
}

void E14FsimAnalysisManager::disableNCCModule(bool isDisable)
{
  m_CC02Module->disable(isDisable);
  m_isNCCModuleDisabled=isDisable;
}

void E14FsimAnalysisManager::disableCSIVeto(bool isDisable)
{
  m_CSIModule->disableVeto(isDisable);
}
